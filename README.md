...
The Castlevania: Symphony of the Night PlayStation Recomp is proudly brought to you by the Black Label HQ team!
...
# Just Play The Game
If you'd like to just play the game via the recomp's PC port, you'll need to download the release from the releases tab OR, and this is our preferred method, use [Github Launcher](https://github.com/SirDiabo/GithubLauncher) to auto update it. Just for clarities sake, you can find the [relese page here](https://github.com/SirDiabo/GithubLauncher/releases/).

## Setting Up Github Launcher
todo
...
## Autorunner.bat
This file does not currently exist. Todo: Make it and add stuff to make it idiot proof....
