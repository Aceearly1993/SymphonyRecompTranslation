...
if /I not "%~1"=="nocredits" (
	...
	echo.
	echo	- flaffymg, creator of PSX Static Recompilation	Tool "RecompOne," also modder who made 16:9 ^(original 4:3 is cool too!^)
	echo	- Derp Princess, fixed hundreds of issues with unmatched calls and crashes, extensive knowledge of the inner-workings of the game and general game knowledge to point out issues with static generation
	...
	echo.
	echo This project was PROUDLY made by huge fans of the series, and mostly important humans! No AI/Gen AI/LLMs were used in the making of this echo Recomp project! Our goal was to allow you to play your legally owned copy of the 	game, natively on your computer, with many nice features!
	echo.
	echo Final Note:
